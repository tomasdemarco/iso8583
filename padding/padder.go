...
type Padder interface {
	// Pack calculates the left and right padding strings required for a given field.
	...
	Pack(lengthPackager int, lengthValue int, encoder encoding.Encoder) (string, string, error)
	// Unpack calculates the number of characters to remove from the left and right
	...
	Unpack(lengthField int) (int, int)
